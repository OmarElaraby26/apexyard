---
# routing-config:override Idris bumped sonnet→opus for higher-quality structured ticket output and interactive interview work. Intentional fork-default change.
name: ticket-manager
persona_name: Idris
