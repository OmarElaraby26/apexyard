...
description: Interview-driven initiative → milestones → tasks with dependency-aware sequencing. Computes topo-sorted milestone order; optionally files each as a Feature ticket with blocks / blocked-by cross-refs.
argument-hint: "<slug>"
---
